...
def get_uid_from_fasta():
	...
	with open(join(INTERMEDIATE, 'brenda_2017_1', '1_1_3__BRENDA_sequences_filtered_2017_1.fasta'), 'r') as f:
		for line in f:
...
def write_outfile(data):
	...
	'''
	with open(join(FINAL, 'brenda_2017_1', 'ec_uid_org_from_fasta_2017_1.tsv'), 'w') as f:
		f.write('uid\tec\n')
...
def write_info_outfile(data):
	...
	properties_object.flatfile(join(FINAL, 'brenda_2017_1', '1-1-3-n_identifier_info_2017_1.tsv'))
